...
module RailsAdmin
  ...
  class ApplicationController < ::ApplicationController
    ...
    def get_model
      ...
      @months_before = if params[:query].present? && params[:query].to_i > 0 && params[:query].to_i <= 5
      ...
      unless correct_venue_id_format.empty?
    ...
    alias user_for_paper_trail _current_user
